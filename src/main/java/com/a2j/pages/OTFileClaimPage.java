...
///#root > div > div > div > div.dashboard-main.dashboard-haslayout > div > div > div.row.mt-3.mb-5 > div:nth-child(1) > a > div > span:nth-child(2)
	...
	@FindBy(xpath = "//input[@id='detailsOfDocs']")
	WebElement documentreference;

	@FindBy(xpath = "//input[@id='detailsOfClaim']")
	WebElement debtIncurred;

	@FindBy(xpath = "//input[@id='whenDebtIncurredStartDate']")
	WebElement debincurdate;

	@FindBy(xpath = "//input[@id='detailsOfMutualClaim']")
	WebElement mutualcredit;

	@FindBy(xpath = "//input[@id='detailsOfSecurityRetention']")
	...
	@FindBy(xpath = "//input[@id='listOfDocumentsAttached']")
	WebElement listdocument;

	@FindBy(xpath = "//textarea[@id='detailsOfMutualDealings']")
	WebElement detailsmutualfund;

	@FindBy(xpath = "//label[text()='Signature of claimant']//input[@id='signOfClaimant']")
	...
	@FindBy(xpath = "//input[contains(@placeholder,'Creditor Type')]")
	WebElement ottype1;

	@FindBy(xpath = "//input[contains(@placeholder,'Creditor Name')]")
	WebElement otname1;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	...
	public OTFileClaimPage() {
	}

	public OTFileClaimPage(WebDriver driver) {
		this.driver = driver;
	...
	public void claimdata(String date, String fctype, String fcname, String location, String finanacical, String ift,
		...
		ottype1.clear();
		ottype1.isEnabled();
		ottype1.sendKeys(fctype);

		otname1.clear();
		otname1.isEnabled();
		otname1.sendKeys(fcname);

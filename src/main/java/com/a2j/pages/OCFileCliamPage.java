...
public class OCFileCliamPage {
	...
	@FindBy(xpath = "//input[@id='substantiatedDocumentsOfDebt']")
	WebElement documentreference;

	@FindBy(xpath = "//input[@id='detailsOfAnyDispute']")
	WebElement arbitary;
	...
	WebElement debtIncurred;
	 ...
	 @FindBy(xpath="//input[@id='howAndWhenDebtIncurred']")
	 WebElement debtwen;
	...
	@FindBy(xpath = "//input[@id='detailsOfMutualCredit']")
	WebElement mutualcredit;

	@FindBy(xpath = "//input[@id='detailsOfAnyRetention']")
	WebElement detailsOfAnyRetention;
	...
	@FindBy(xpath = "//input[contains(@placeholder,'Enter Your name Here')]")
	WebElement blkname;

	@FindBy(xpath = "//input[@id='relationWithCreditor']")
	WebElement relationcreditor;

	@FindBy(xpath = "//textarea[@id='addressOfAuthorisedPerson']")
	...
	@FindBy(xpath = "//input[contains(@placeholder,'OC Type')]")
	WebElement octype1;

	@FindBy(xpath = "//input[contains(@placeholder,'OC Name')]")
	WebElement ocname1;

	@FindBy(xpath = "//input[@placeholder='Location']")
	WebElement location1;

	@FindBy(xpath = "//input[contains(@placeholder,'Nature of business')]")
	WebElement Financial;

	@FindBy(xpath = "//input[contains(@placeholder,'Instrument Of Financial Transaction')]")
	WebElement Instrument;

	@FindBy(xpath = "//input[contains(@placeholder,'Document ID')]")
	...
	@FindBy(xpath = "//input[@placeholder='OC Amount INR']")
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	...
	public OCFileCliamPage() {
	}

	public OCFileCliamPage(WebDriver driver) {
		this.driver = driver;
    ...
    public void debincuredwen(String dbcurdwen) {
	debtwen.clear();
	debtwen.isEnabled();
	debtwen.sendKeys(dbcurdwen);
}
	...
	public void detailsOfAnyRetention(String retention) {
		detailsOfAnyRetention.clear();
		detailsOfAnyRetention.isEnabled();
		detailsOfAnyRetention.sendKeys(retention);
	...
	public void claimdata(String date, String ocname, String octype, String location, String finanacical, String ift,
		...
		octype1.clear();
		octype1.isEnabled();
		octype1.sendKeys(ocname);

		ocname1.clear();
		ocname1.isEnabled();
		ocname1.sendKeys(octype);

...
public class EmployeeEFileCliamPage {
	WebDriver driver;
...
///#root > div > div > div > div.dashboard-main.dashboard-haslayout > div > div > div.row.mt-3.mb-5 > div:nth-child(1) > a > div > span:nth-child(2)
	...
	@FindBy(xpath = "//p//textarea[@id='detailsOfMutualDealings']")
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	...
	public EmployeeEFileCliamPage() {
	}

	public EmployeeEFileCliamPage(WebDriver driver) {
		this.driver = driver;
	...
	public void mutualcredit(String mutual) throws InterruptedException {
		driver.manage().window().maximize();
		Thread.sleep(2000);
		JavascriptExecutor js1 = (JavascriptExecutor) driver;

		js1.executeScript("arguments[0].scrollIntoView(true)", mutualcredit);
		mutualcredit.clear();
	...
	public void annexturewe1(String workman1) {
		we1.clear();
		we1.sendKeys(workman1);
	}
	
	public void annextureweid(String workmanid1) {
		id1.clear();
		id1.sendKeys(workmanid1);
	}
	public void annextureweta1(String workmantta1) {
		ta1.clear();
		ta1.sendKeys(workmantta1);
	}
	public void annexturewepmd1(String workmanpmd1) {
		pad1.clear();
		pad1.sendKeys(workmanpmd1);
	}

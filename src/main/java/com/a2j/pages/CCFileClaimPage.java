...
///#root > div > div > div > div.dashboard-main.dashboard-haslayout > div > div > div.row.mt-3.mb-5 > div:nth-child(1) > a > div > span:nth-child(2)
	...
	@FindBy(xpath = "//textarea[@id='howDebtIncurred']")
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	...
	public CCFileClaimPage() {
	}

	public CCFileClaimPage(WebDriver driver) {
		this.driver = driver;
	...
	public void claimdata(String date, String crtype, String crname, String location, String finanacical, String ift,
		...
		crtype1.clear();
		crtype1.isEnabled();
		crtype1.sendKeys(crtype);

		crname1.clear();
		crname1.isEnabled();
		crname1.sendKeys(crname);
